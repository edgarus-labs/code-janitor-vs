...
namespace SteveCadwallader.CodeJanitor.Logic.Cleaning
{
    ...
    internal class CodeCleanupAvailabilityLogic
    {
        ...
        internal bool CanCleanupDocument(Document document, bool allowUserPrompts = false)
        {
            ...
            {
                OutputWindowHelper.DiagnosticWriteLine($"CodeCleanupAvailabilityLogic.CanCleanupDocument returned false for '{document.FullName}' due to the document language not being included within CodeJanitor Options.");
                return false;
            }
            ...
            {
                OutputWindowHelper.DiagnosticWriteLine($"CodeCleanupAvailabilityLogic.CanCleanupDocument returned false for '{document.FullName}' due to the file name being excluded within CodeJanitor Options.");
                return false;
            }

            if (!IsFileNameIncludedByOptions(document.FullName))
            {
                OutputWindowHelper.DiagnosticWriteLine($"CodeCleanupAvailabilityLogic.CanCleanupDocument returned false for '{document.FullName}' due to the file name not being included within CodeJanitor Options.");
                return false;
            }
        ...
        internal bool CanCleanupProjectItem(ProjectItem projectItem)
        {
            ...
            {
                OutputWindowHelper.DiagnosticWriteLine($"CodeCleanupAvailabilityLogic.CanCleanupProjectItem returned false for '{projectItemFileName}' due to the project item language not being included within CodeJanitor Options.");
                return false;
            }

            if (IsFileNameExcludedByOptions(projectItemFileName))
            {
                OutputWindowHelper.DiagnosticWriteLine($"CodeCleanupAvailabilityLogic.CanCleanupProjectItem returned false for '{projectItemFileName}' due to the file name being excluded within CodeJanitor Options.");
                return false;
            }
