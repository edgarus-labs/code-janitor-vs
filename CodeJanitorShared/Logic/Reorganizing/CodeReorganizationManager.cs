...
namespace CodeJanitor.Logic.Reorganizing
{
    ...
    internal class CodeReorganizationManager
    {
        ...
        internal void MoveItemAboveBase(BaseCodeItem itemToMove, BaseCodeItem baseItem)
        {
            ...
            new UndoTransactionHelper(_package, Resources.CodeJanitorMoveItemAbove).Run(
        ...
        internal void MoveItemBelowBase(BaseCodeItem itemToMove, BaseCodeItem baseItem)
        {
            ...
            new UndoTransactionHelper(_package, Resources.CodeJanitorMoveItemBelow).Run(
        ...
        internal void MoveItemIntoBase(BaseCodeItem itemToMove, ICodeItemParent baseItem)
        {
            ...
            new UndoTransactionHelper(_package, Resources.CodeJanitorMoveItemInto).Run(
        ...
        internal void Reorganize(Document document)
        {
            ...
            new UndoTransactionHelper(_package, string.Format(Resources.CodeJanitorReorganizeFor0, document.Name)).Run(
                delegate
                {
                    ...
                    _package.IDE.StatusBar.Text = string.Format(Resources.Reorganize_CodeJanitorIsReorganizing0, document.Name);
                    ...
                    _package.IDE.StatusBar.Text = string.Format(Resources.CodeJanitorReorganized0, document.Name);
