...
namespace CodeJanitor.UI.Dialogs.Options
{
    ...
    public class OptionsViewModel : Bindable
    {
        ...
        public OptionsViewModel(CodeJanitorPackage package, Type initiallySelectedPageType = null)
        {
        ...
        private void OnExportCommandExecuted(object parameter)
        {
            ...
            {
                Title = Resources.CodeJanitorExport + activeSettingsName,
                FileName = "CodeJanitor",
                DefaultExt = ".config",
            ...
            if (dialog.ShowDialog() == true)
            {
                try
                {
                    ...
                    MessageBox.Show(string.Format(Resources.CodeJanitorHasSuccessfullyExported + activeSettingsName + Resources.To0, dialog.FileName),
                                     Resources.CodeJanitorExport + activeSettingsName + Resources.Successful, MessageBoxButton.OK, MessageBoxImage.Information);
                }
                catch (Exception ex)
                {
                    OutputWindowHelper.ExceptionWriteLine(Resources.UnableToExport + activeSettingsName, ex);
                    MessageBox.Show(Resources.CodeJanitorWasUnableToExport + activeSettingsName + Resources.SeeOutputWindowForMoreDetails,
                                     Resources.CodeJanitorExport + activeSettingsName + Resources.Unsuccessful, MessageBoxButton.OK, MessageBoxImage.Error);
                }
            }
        }
        ...
        private void OnImportCommandExecuted(object parameter)
        {
            ...
            {
                Title = Resources.CodeJanitorImport + activeSettingsName,
                DefaultExt = ".config",
                Filter = Resources.ConfigFilesConfigConfigAllFiles,
            ...
            if (dialog.ShowDialog() == true)
            {
                try
                {
                    ...
                    MessageBox.Show(string.Format(Resources.CodeJanitorHasSuccessfullyImported1From0, dialog.FileName, activeSettingsName),
                                    Resources.CodeJanitorImport + activeSettingsName + Resources.Successful, MessageBoxButton.OK, MessageBoxImage.Information);
                }
                catch (Exception ex)
                {
                    OutputWindowHelper.ExceptionWriteLine(Resources._UnableToImport + activeSettingsName, ex);
                    MessageBox.Show(Resources.CodeJanitorWasUnableToImport + activeSettingsName + Resources.SeeOutputWindowForMoreDetails,
                                    Resources.CodeJanitorImport + activeSettingsName + Resources.Unsuccessful, MessageBoxButton.OK, MessageBoxImage.Error);
                }
            }
        }
        ...
        private void OnResetToDefaultsCommandExecuted(object parameter)
        {
            ...
            var result = MessageBox.Show(Resources.AreYouSureYouWantAll + activeSettingsName + Resources.OptionsViewModel_OnResetToDefaultsCommandExecuted_ToBeResetToTheirDefaults + Environment.NewLine + Environment.NewLine +
                                         ...
                                         Resources.CodeJanitorConfirmationForReset + activeSettingsName,
            ...
            if (result == MessageBoxResult.Yes)
            {
                try
                {
                    ...
                    MessageBox.Show(string.Format(Resources.CodeJanitorHasSuccessfullyReset + activeSettingsName + "."),
                                    Resources.CodeJanitorReset + activeSettingsName + Resources.Successful, MessageBoxButton.OK, MessageBoxImage.Information);
                }
                catch (Exception ex)
                {
                    OutputWindowHelper.ExceptionWriteLine(Resources.UnableToReset + ActiveSettingsName, ex);
                    MessageBox.Show(Resources.CodeJanitorWasUnableToReset + activeSettingsName + Resources.SeeOutputWindowForMoreDetails,
                                    Resources.CodeJanitorReset + activeSettingsName + Resources.Unsuccessful, MessageBoxButton.OK, MessageBoxImage.Error);
                }
            }
        }
        ...
        private bool CheckToSavePendingChangesShouldCancelOperation()
        {
            if (HasChanges)
            {
                var result = MessageBox.Show(Resources.YouHavePendingChangesDoYouWantToSaveThemBeforeContinuing,
                    Resources.CodeJanitorConfirmationToSavePendingChanges,
        ...
        /// <summary>
        /// Refreshes the default/package settings which are used throughout CodeJanitor.
        /// </summary>
        /// <remarks>
