...
{
    /// <summary>
    /// Unit tests for <see cref="EnsureFinalNewlineConverter" />. Verifies a final line break is
    /// added when missing and existing endings are left untouched (headless-Roslyn cleanup block,
    /// BL-018, C#-only per scope).
    /// </summary>
    [TestClass]
    public class EnsureFinalNewlineConverterTests
    {
        ...
        [TestMethod]
        [TestCategory("Transformations UnitTests")]
        public void MultipleTrailingNewlines_LeftUntouched()
        {
            var input = "class C\n{\n}\n\n\n";
